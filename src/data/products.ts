...
export const products: Product[] = [
  ...
  { id: 8, name: "Bluetooth Travel Mouse", price: 3299, category: "Mouse", image: "/mouse-travel.jpg", rating: 4.3, description: "Compact Bluetooth mouse perfect for travel." },
  ...
  { id: 10, name: "Messenger Bag Classic", price: 7499, category: "Bags", image: "/messenger-bag-classic.jpg", rating: 4.5, description: "Classic messenger bag with multiple compartments." },
  ...
  { id: 13, name: "Wireless Charging Pad", price: 2499, category: "Chargers", image: "/wireless-charging-pad.jpg", rating: 4.4, description: "Qi wireless charging pad with fast charge support." },
