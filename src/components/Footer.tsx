...
const Footer = () => (
  <footer className="border-t bg-secondary/50 mt-20">
    <div className="container py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
      <div>
        <h4 className="font-semibold text-foreground mb-3">Device Gear Store</h4>
      ...
      <div>
        ...
        <div className="flex flex-col gap-2 text-sm text-muted-foreground">
          <span>help@devicegear.com</span>
          <span>1-800-DEVICE</span>
        </div>
      </div>
    </div>
    <div className="border-t">
      <div className="container py-6 text-center text-xs text-muted-foreground">
        © 2026 Device Gear Store. All rights reserved.
      </div>
    </div>
  </footer>
);
